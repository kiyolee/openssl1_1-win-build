...
our %config = (
  ...
  perl_version => "5.26.1",
  perlargv => [ "--prefix=C:\\Program Files (x86)\\OpenSSL-1_1", "--with-zlib-include=..\\..\\zlib", "--with-zlib-lib=..\\..\\zlib\\build-VS2017\\Release\\libz-static.lib", "VC-WIN32", "no-shared", "no-dynamic-engine", "zlib" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
