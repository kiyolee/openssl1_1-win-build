...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ ".\\Configurations\\00-base-templates.conf", ".\\Configurations\\10-main.conf", ".\\Configurations\\50-masm.conf", ".\\Configurations\\shared-info.pl" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  perl_version => "5.26.1",
  perlargv => [ "--prefix=C:\\Program Files\\OpenSSL-1_1", "--with-zlib-include=..\\..\\zlib", "--with-zlib-lib=..\\..\\zlib\\build-VS2017\\x64\\Release\\libz-static.lib", "VC-WIN64A-masm", "no-shared", "no-dynamic-engine", "zlib" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
